        ...
        <div>
            ...
            <div class="container">
                <div class="abs-center">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <div class="input-group mt-3 mb-3">
                                ...
                                <asp:TextBox ID="TxtBuscarDocumento" runat="server" placeholder="Ingrese documento a buscar"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <div class="input-group mt-3 mb-3">
                                ...
                                <i class="glyphicon glyphicon-user"></i><span class="input-group-text">Tipo documento&nbsp;&nbsp; 
                    ...
                    <!---------------------------Botones--------------------------------------------------------------------------->
                    <asp:Button ID="btnModificar" class="btn btn-success mb-2 " runat="server" Text="Guardar Modificación" />
